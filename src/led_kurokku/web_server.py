        ...
        <head>
            ...
            <style>
                :root {
                    ...
                    --inactive-color: #220000; /* Darker for more contrast */
                    --glow-intensity: 0px;
                    --segment-opacity: 0.5;
                }
                ...
                .segment-a { top: 0; }
                .segment-g { top: 50%; transform: translateY(-50%); } /* Middle segment precisely centered */
                .segment-d { bottom: 0; }
                ...
                .segment-b { top: 5%; right: 0; }
                .segment-c { bottom: 5%; right: 0; }
                .segment-e { bottom: 5%; left: 0; }
                .segment-f { top: 5%; left: 0; }
